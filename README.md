...
[![build_status](https://travis-ci.org/dls-controls/pymalcolm.svg?branch=master)](https://travis-ci.org/dls-controls/pymalcolm)
[![Coverage](https://coveralls.io/repos/dls-controls/pymalcolm/badge.svg?branch=master&service=github)](https://coveralls.io/github/dls-controls/pymalcolm?branch=master)
[![readthedocs](https://readthedocs.org/projects/malcolmjs/badge/?version=latest)](http://malcolmjs.readthedocs.org)
[![health](https://landscape.io/github/dls-controls/pymalcolm/master/landscape.svg?style=flat)](https://landscape.io/github/dls-controls/pymalcolm/master)
