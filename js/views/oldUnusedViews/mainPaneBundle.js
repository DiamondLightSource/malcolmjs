...
var MainPane = React.createClass({displayName: "MainPane",
  ...
  render: function() {
    return(
      React.createElement("div", {style: MainPaneStyle}, React.createElement(Panel, {theme: "flexbox", useAvailableHeight: true, buttons: [
        ...
        React.createElement(Tab, {title: "View"}, 
          ...
          React.createElement(Footer, null, React.createElement("div", {id: "blockDock", style: BlockDockStyle}, 
