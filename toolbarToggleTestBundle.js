  ...
  render: function () {
    ...
    return (
      React.createElement(Panel, {theme: "flexbox", useAvailableHeight: true, buttons: [
          ...
          React.createElement(ToggleButton, {title: "Toggle Footer", active: this.state.footers, onChange: this.handleToggleFooters}, 
            React.createElement("i", {className: "fa fa-wrench"})
          )
        ]}, 
        React.createElement(Tab, {title: "One", icon: "fa fa-plane", showToolbar: this.state.toolbars, showFooter: this.state.footers}, 
...
React.render(React.createElement(MyPanel, null),document.getElementById('root'));
